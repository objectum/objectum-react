			...
			<div>
				<div className="row">
					<div className="col-sm-12">
						<TreeGrid {...me.props} id="menuItems" ref="menuItems" store={me.props.store} view="objectum.menuItem" refresh={me.state.refresh} onSelectParent={parent => me.parent = parent} params={{menu: me.menu}}>
