			...
			<div>
				<div className="row">
					<div className="col-sm-12">
						<Grid {...me.props} id="menuItems" ref="menuItems" store={me.props.store} query="objectum.menuItem" tree={true} system={true} refresh={me.state.refresh} onSelectParent={parent => me.parent = parent} params={{menu: me.menu}}>
