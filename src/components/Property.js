...
import {StringField, NumberField, BooleanField, DictField, ChooseField} from "..";
				...
				<Tab key="Tab1" label="Information">
					...
					>
						...
						<div className="form-row">
							...
							<div className="form-group col-md-6">
								{this.state.type >= 1000 && <DictField property="removeRule" label="Remove rule" recs={removeRuleRecs} value="set null" />}
							</div>
						</div>
						<div className="form-row">
							<div className="form-group col-md-6">
